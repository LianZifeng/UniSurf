...
def multiProcessing(file):
    ...
    nib.save(nib.Nifti1Image(sdf, affine), os.path.join(file, 'lh.white.SDF.nii.gz'))
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Calulate the pseudo ground-truth SDF from the tissue map')
